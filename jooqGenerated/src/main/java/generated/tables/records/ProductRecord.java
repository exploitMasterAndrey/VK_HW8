...
public class ProductRecord extends UpdatableRecordImpl<ProductRecord> implements Record4<Integer, String, String, Integer> {
    ...
    /**
     * Setter for <code>public.product.factory_name</code>.
     */
    public ProductRecord setFactoryName(String value) {
        set(2, value);
        return this;
    }
    ...
    public Field<String> field3() {
        return Product.PRODUCT.FACTORY_NAME;
    }
     ...
     */
    public ProductRecord(Integer id, String name, String factoryName, Integer count) {
        super(Product.PRODUCT);
    ...
    public ProductRecord(generated.tables.pojos.Product value) {
        ...
        if (value != null) {
            ...
            setFactoryName(value.getFactoryName());
